...
\\ sd = sprite destination address
\\ Constants:
plane_table = &1D40      \ in X.bin file
plane_kill_count = &1D5B
...
.backgnd_sprite_addr_table
    ...
    EQUW &1CA0                \ sprite source addr
    EQUW &7393, &7149, &7660, &7599, &7344, &78C9, &76B4 \ destination addrs
    EQUW &1CC0                \ next sprite source addr, ...
